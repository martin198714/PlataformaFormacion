...
/* =========================================================
   TU SERVICIO ORIGINAL (NO SE TOCA)
========================================================= */
...
/* =========================================================
   🔥 NUEVO: REGISTRAR ARCHIVO (TU FUNCIÓN)
========================================================= */
...
/* =========================================================
   🔥 NUEVO: ENLAZAR ARCHIVO A PERFIL (IMPORTANTE PARA CONTRATOS)
========================================================= */

async function vincularArchivoPerfil(archivoId, perfilId) {

  if (!archivoId || !perfilId) return;

  await db.query(`
    INSERT INTO ARCHIVO_PERFILES
    (ARCHIVO_ID, PERFIL_ID)
    VALUES (?, ?)
  `, [
    archivoId,
    perfilId
...
module.exports = {
  ArchivoService: module.exports, // mantiene tu clase funcionando
  registrarArchivo,
  vincularArchivoPerfil
};